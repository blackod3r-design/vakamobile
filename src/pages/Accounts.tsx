...
const Accounts = () => {
  ...
  return (
    <div 
        className={`p-8 animate-fade-in ${isDark ? 'text-white' : 'text-gray-900'}`} 
    ...
    >
        ...
        <div className="flex gap-2">
          ...
          <Dialog open={isTransferOpen} onOpenChange={setIsTransferOpen}>
            <DialogTrigger asChild>
              <Button variant="outline" className={`gap-2 ${isDark ? 'bg-[#181818] border-[#27272a] text-white hover:bg-[#202020]' : ''}`}>
      ...
      {accounts.length === 0 ? (
        <div className={`text-center py-12 ${isDark ? 'text-gray-400' : ''}`}>
            ...
            return (
              ...
              >
                ...
                <div className={`relative z-10 flex items-baseline justify-center gap-1.5 ${isDPF ? 'mb-10' : 'mb-6'}`}>
                  <span className={`text-3xl font-light ${isDark ? 'text-zinc-500' : 'text-gray-400'}`}>{account.currency}</span>
                ...
                {isDPF && (
                  <div className="relative z-10 w-full">
                    <div className={`mb-2 flex justify-center gap-2 text-xs font-medium ${isDark ? 'text-zinc-400' : 'text-gray-500'}`}>
                      <span>Progreso:</span>
      ...
      <Dialog open={!!selectedAccountId} onOpenChange={(open) => !open && setSelectedAccountId(null)}>
        <DialogContent className={`max-w-4xl max-h-[90vh] overflow-hidden flex flex-col animate-scale-in backdrop-blur-xl ${isDark ? 'bg-[#0f0f0f]/95 border-zinc-800 text-white' : 'bg-white/95'}`}>
          {(() => {
            ...
            return (
              <div className="flex flex-col h-full overflow-hidden space-y-6">
                <DialogHeader className="shrink-0">
                  <DialogTitle className={`text-2xl ${isDark ? 'text-white' : 'text-gray-900'}`}>Detalles de la Cuenta</DialogTitle>
                </DialogHeader>
                ...
                <div className="grid md:grid-cols-2 gap-6 h-full overflow-hidden">
                  ...
                  <div className="space-y-4 overflow-y-auto pr-2">
                    ...
                    <div className="text-center space-y-4">
                        {isEditingName ? (
                            ...
                            <Input
                                ...
                                className={`text-lg font-semibold text-center w-48 ${isDark ? 'bg-zinc-800 text-white border-zinc-700' : ''}`}
                                autoFocus
                            />
                            ...
                            <h3 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-800'}`}>{account.name}</h3> 
                        ...
                        <div className="flex items-baseline justify-center gap-1 mt-2">
                            ...
                            <span className={`text-6xl font-bold tracking-tight ${isDark ? 'text-white' : 'text-gray-900'}`}>{account.balance.toLocaleString()}</span>
                        </div>
                    ...
                    {displayInfo.isDPF && account.plazoDias && account.fechaApertura && (
                      <div className={`space-y-4 p-4 rounded-lg ${isDark ? 'bg-zinc-900 border border-zinc-800' : 'bg-muted/50'}`}>
                        ...
                        {account.tipoCuenta === 'dpf-mensual' && (
                          <div className={`space-y-3 pt-2 border-t ${isDark ? 'border-zinc-700' : 'border-border'}`}>
                    ...
                    {!account.imageUrl && (
                      <div className={`border-2 border-dashed rounded-xl p-4 ${isDark ? 'border-zinc-700' : 'border-border'}`}>
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <Button size="lg" variant="outline" className={`gap-2 w-full ${isDark ? 'bg-transparent border-zinc-700 text-white hover:bg-white/5' : ''}`} onClick={() => {
                          setTransactionAccountId(account.id);
                  ...
                  <div className="flex flex-col space-y-4">
                    ...
                    {accountTransactions.length === 0 ? (
                      <div className={`flex-1 flex items-center justify-center rounded-xl border border-dashed min-h-[200px] ${isDark ? 'bg-zinc-900 border-zinc-700' : 'bg-muted/20'}`}>
                      ...
                      <div className="h-[550px] overflow-y-auto scrollbar-hide space-y-3 pr-1">
                        {accountTransactions.slice().reverse().map((transaction) => (
                          <div key={transaction.id} className={`flex justify-between items-center p-6 rounded-lg transition-colors ${isDark ? 'bg-zinc-900 hover:bg-zinc-800' : 'bg-muted/50 hover:bg-muted'}`}>
                            <div className="flex-1">
                              <p className={`font-semibold text-xl ${isDark ? 'text-white' : ''}`}>{transaction.description}</p>
